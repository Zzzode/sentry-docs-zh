...
title: 问题警报
sidebar_order: 2
description: "了解有关 Sentry 集成平台问题警报 webhooks 的更多信息。"
---

已作为[警报规则操作](/organization/integrations/integration-platform/#alerts)提供的 Sentry 集成可以接收问题警报 webhooks。

下面的交互式演示展示了如何设置可以接收问题警报的内部集成。
...
以下两个字段仅用于[警报规则操作 UI 组件](/organization/integrations/integration-platform/ui-components/alert-rule-action)。
