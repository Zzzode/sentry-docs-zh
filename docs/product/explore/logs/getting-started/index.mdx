...
title: 设置
sidebar_order: 0
description: "了解如何使用我们支持的 SDK 设置 Sentry 的日志功能。"
---

要设置 Sentry 日志，请使用下方支持的 SDK 链接。设置完成后，您将能够在 Sentry 中查看和查询从应用程序发送的日志和参数。
...
我们正在积极为其他 SDK 添加日志功能。请查看以下 GitHub 问题以获取最新更新：
...
如果您在上面没有看到您的平台，请通过 [GitHub](https://github.com/getsentry/sentry/discussions/86804) 或 [Discord](https://discord.gg/sentry) 联系我们，我们会优先考虑！